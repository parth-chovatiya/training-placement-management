          ...
          <div className={classes.desc}>
            <ul className={classes.mainul}>
              ...
              <li className={classes.point}>
                ...
                end semester examinations. However, extended students can
              ...
              <p>
                Students who have graduated in 2020, but not placed due to
                various genuine reasons, may be permitted to re-register with
                the approval of the concerned authorities. They will be
              ...
              <b>
                *The registration fee will not be refunded under any
                circumstance.
              </b>
              ...
              <b>
                **This office reserves the right to refuse permission to a
                student to attend the selection process/PPT, if they do not
                dress up formally. Students are expected to know the norms for
                formal wear; for the benefit of those who claim ignorance,
                please note that the following are strictly not allowed:
              </b>
              ...
              <li className={classes.point}>
                ...
                <ul>
                  <li>
                    A student who applies and gets shortlisted is bound to go
                    through the entire selection process unless rejected midway
                    by the company. Any student who withdraws deliberately in
                    the middle of a selection process will be disallowed from
                    placement for the rest of the academic year.
                  </li>
                  <li>
                    LATE COMERS FOR APTITUDE TEST / GD / INTERVIEW may not be
              ...
              <li className={classes.point}>
                ...
                <ul>
                  <li>
                    ...
                    behaviour in every action they take during the placement
                    process. Any student found violating the discipline rules
                    set by the company or defaming the institute's name will be
                    disallowed from the placements for the rest of the academic
                    year.
                  </li>
                  <li>
                    Students found cheating or misbehaving in the selection
                    process (Test / GD / Interview) will be disallowed from the
                    placements for the rest of the academic year.
                  </li>
                  <li>Dress code should be maintained as in #17.</li>
                </ul>
              </li>
              ...
              <li className={classes.point}>
                ...
                <p>
                  ...
                  from placements. The following rules are applicable to
                  companies that made PPO through the Placement Office.
                </p>
                <ul>
                  <li>
                    In case the student is required to make a decision on the
                    PPO within a specified period (no longer than 10 days), then
                    such a PPO must be made on or before 11 th September
                  </li>
                  <li>
                    Once a student accepts a PPO, he / she shall be
                    de-registered from placement.
                  </li>
                  <li>
                    In case the PPO is an open offer, then the student will be
                    permitted to participate in the Placement process until the
                    day/session in which the company that has given the PPO is
                    slotted to come to campus. Such a PPO may be offered after
                    11 th September also.
                  </li>
                  <li>
                    The offer of PPO (by the company) and its acceptance (by the
                    student) shall be through placement office only.
                  </li>
                </ul>
              </li>
              <li className={classes.point}>
                ...
                <ul>
                  <li>
                    If a student receives more than one offer in a session/day
                    and if there is a delay in the announcement of results by
                    some companies, the student is bound to accept/reject the
                    job offer of the company whose results are declared in time
                  </li>
                  <li>
                    If the results are declared on the same session / day, the
                    student may choose from the offers in hand and inform the
                    placement office of his/her choice, within 24 hrs of
              ...
              <li className={classes.point}>
                ...
                through the offer letter and taking actions therein such as
                submission of documents lies entirely with the student. All
                offers (made by the companies) shall be through this office
                only. This office will not be in a position to resolve problems,
                if any, that may arise with respect to offers made directly to
              ...
              <li className={classes.point}>
                ...
                student becomes eligible again to seek placement through this
                office. Students should go through and understand instructions
